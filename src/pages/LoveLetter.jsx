...
const LoveLetter = () => {
  ...
  // Prevent direct navigation to this route — always redirect to Home
  useEffect(() => {
        ...
        <div className={`envelope ${openEnvelope ? "active" : ""}`}>
          ...
          <div className="munna envelope-flap text-black relative">
            <div className="munna absolute left-1/2 top-[20%] -translate-x-1/2 flex items-center justify-center flex-col md:gap-y-2">
              <span className="munna font-sriracha md:text-2xl text-lg">
                Envelope Of Love
              </span>
              <span className="munna font-dancingScript md:text-3xl text-xl">
                Dear Trisha
              </span>
            </div>
          </div>
