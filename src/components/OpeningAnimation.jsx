...
const OpeningAnimation = ({ animateOut, onSkip }) => {
  const makeItRain = () => {
    let disabled = true;
  ...
  return (
    <main
      className={`bg-[#ee9ca7] w-full h-screen overflow-hidden absolute top-0 left-0 loader-wrapper ${animateOut ? "slide-up-fade-out" : ""}`}
    >
      {/* --- SVG Decoration Container --- */}
      <svg
        className="full-screen-deco"
        viewBox="0 0 100 100"
      ...
      >
        ...
        <circle
          ...
          className="deco-shape big-circle"
        />
        ...
        <circle
          ...
          strokeWidth="1"
          fill="none"
          className="deco-shape small-ring"
        />
        ...
        <circle
          ...
          r="3"
          fill="#8B0000"
          className="deco-shape particle-red-1"
        />
        {/* White particle 1 */}
        <circle
          cx="90"
          ...
          className="deco-shape particle-white-1"
        />
        ...
        <circle
          ...
          className="deco-shape particle-pink-1"
        />
        ...
        <circle
          ...
          className="deco-shape particle-red-2"
        />
        {/* White particle 2 */}
        <circle
          cx="10"
          ...
          className="deco-shape particle-white-2"
        />
        ...
        <circle
          ...
          className="deco-shape particle-pink-2"
        />
        ...
        <circle
          ...
          className="deco-shape particle-dot-1"
        />
        <circle
          cx="75"
          cy="45"
          ...
          className="deco-shape particle-dot-2"
        />
        <circle
          cx="48"
          cy="88"
          ...
          className="deco-shape particle-dot-3"
        />
        <circle
          cx="55"
          cy="20"
          ...
          className="deco-shape particle-dot-4"
        />
      </svg>
      <div id="CakeWrapper">
        <div className="MUNNA cake">
          ...
          <div className="MUNNA cakeText">
            <h1 className="MUNNA cakeText-title">Happy 22th Birthday!</h1>
            <div className="MUNNA cakeText-name">
              Fibri <div className="MUNNA cakeText-kitty-bow"></div>
            </div>
            {/* Skip Button */}
            <button onClick={onSkip} id="btn__opening-skip">
              <svg
                className="w-6 h-6"
