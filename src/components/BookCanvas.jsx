...
import fibri from "../assets/fibri2.jpeg";
...
const BookCanvas = ({ active, setActive }) => {
  ...
  return (
    <div
      className={`boxMail ${active ? "hidden opacity-0 pointer-events-none" : "opacity-100 visible"}`}
    >
      ...
      >
        <div className="card1">
          <div className="cover-text-wrapper">
            <h4 className="username">
              Dear Fibri<span className="underline"></span>
            </h4>
            <h3 className="cover-title">Happy Birthday!</h3>
            <p className="cover-subtitle">
              A purr-fect-to message just for you... 💌
            </p>
          </div>

          {/* User Image remains the same */}
          <div className="userImg">
            <img src={fibri} alt="Recipient's Photo" />
          </div>
        ...
        <div className="card2">
          <div className="card2-content">
            <h3 className="card2-recipient">To You!</h3>
            ...
            <div className="card2-message-text italic">
              <article style={{ marginBottom: "8px" }}>
                Happy Birthday, Fibri ❤️
              </article>
              <article style={{ marginBottom: "10px" }}>
                From the very first time our paths crossed, something inside me
                quietly changed, like life was gently steering me toward someone
                who truly belongs in my story. You filled spaces in my heart I
                didn’t even realize were empty, and somehow made my ordinary
                days feel deeper and more meaningful than ever before.
              </article>
              <article style={{ marginBottom: "10px" }}>
                On your birthday, I just want you to know this: wherever life
                takes you, I’ll always be someone you can turn to. Not to hold
                you back, not to claim every step beside you, but to be there
                when you need support, when you need strength, or simply when
                you need someone who understands. And more than anything, I hope
                I get to witness your journey unfold, to see how beautifully
                your story grows all the way to its last page.
              </article>
              <article style={{ marginBottom: "10px" }}>
                Today isn’t just about adding another year to your life… <br />
                it’s about celebrating the person who makes my world gentler,
                brighter, and endlessly more beautiful.it’s about celebrating
                the person who makes my world gentler, brighter, and endlessly
                more beautiful. worth living. Happy Birthday. Anjay.
              </article>
            </div>
            ...
            <div className="corner-ribbon top-left">
              ...
              >
                ...
                <path
                  fill="#fcc4bf"
                  d="M59.9 45.07c1.7.34 2.67-4.23 3.74-5.48c1.68-1.95 5.66-1.57 5.59-4.18c-.05-2.06-7.63-3.01-10.36.81c-1.9 2.67-1.68 8.31 1.03 8.85"
                />
                <path
                  fill="#ff605e"
                  d="M75.11 31.77s1.13 1.38 2.13 3.86c.74 1.82 1.54 4.48 1.54 4.48s3.68-3.21 6.83-4.95c3.14-1.74 18.15-7.07 18.54.2c.31 5.91-10.75 5.79-15.94 7.9c-3.65 1.48-8.62 4.28-8.62 4.28v6.02s2.4 2.56 8.02 3.03s20.03.3 22.87.42c5.91.25 7.98 2.9 7.98 6.05c0 3.14-1.11 4.43-.74 4.84c.48.54 2.95-1.43 4.29-6.52s2.37-14.6 1.97-22.75c-.47-9.63-2.37-22.52-6.67-24.92s-16.84.8-24.2 3.95c-12.38 5.3-18 14.11-18 14.11m-24.74 7.97s.46-2.37 1.33-4.25c.68-1.47 1.93-3.28 1.93-3.28s-2.36-6.15-11.05-11.14s-26.87-8.89-32.66-6.69c-2.88 1.09-5.67 8.48-6.52 19.7c-.73 9.74.23 21.4 3.3 27.15c2.31 4.33 8.17 7.55 9.95 5.77c.87-.87-5.77-3.89.56-7.87c3.67-2.3 10.69-2.1 16.78-2.5s8.69-.1 11.89-.9s5.19-2 5.19-2s-.75-2.5-.9-3.7c-.21-1.64-.34-2.98-.34-2.98s-2.11-1.19-7.65-2.11c-5.43-.91-14.35-.71-14.48-6.69c-.17-7.59 8.59-5.69 12.68-4s9.49 4.99 9.99 5.49"
                />
              </svg>
            </div>
            <div className="corner-ribbon bottom-right"></div>
            <div className="confetti-dots"></div>
            <p className="signature">Your "Apalah basing", Adit</p>
          </div>
        </div>
      </div>
    </div>
